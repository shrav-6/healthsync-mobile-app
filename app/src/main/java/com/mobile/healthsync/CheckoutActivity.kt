...
class CheckoutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_checkout) // Ensure you have a layout for CheckoutActivity

        PaymentConfiguration.init(this, PUBLISH_KEY)

        getCustomerID()

        val button = findViewById<Button>(R.id.button2) // Make sure you have a button in your checkout layout
